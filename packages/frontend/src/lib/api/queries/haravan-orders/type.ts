...
export enum OrderHistoryStatus {
  ...
  'NOTFULFILLED' = 'NOTFULFILLED', // Chờ giao hàng
  'FULFILLED' = 'FULFILLED', // Đã giao hàng
  'NULL' = 'NULL', // Chờ giao hàng
  'PARTIAL' = 'PARTIAL', // Giao một phần
  'RESTOCKED' = 'RESTOCKED', // Đã trả hàng
}
...
export const ORDER_FULFILMENT_STATUS_LABEL = {
  [OrderFulfilmentStatus.WAITING_FOR_PICKUP]: 'Chờ lấy hàng',
  [OrderFulfilmentStatus.PICKING_UP]: 'Đang đi lấy',
  [OrderFulfilmentStatus.DELIVERING]: 'Đang giao hàng',
  [OrderFulfilmentStatus.DELIVERED]: 'Đã giao hàng',
  [OrderFulfilmentStatus.DELIVERY_CANCELED]: 'Hủy giao hàng',
  [OrderFulfilmentStatus.RETURNED]: 'Chuyển hoàn',
  [OrderFulfilmentStatus.NOT_DELIVERED_YET]: 'Chưa giao hàng',
  [OrderFulfilmentStatus.CUSTOMER_NOT_FOUND]: 'Không gặp khách',
  [OrderFulfilmentStatus.WAITING_FOR_RETURN]: 'Chờ chuyển hoàn',
  [OrderFulfilmentStatus.INCOMPLETE]: 'Chưa hoàn thành',
  [OrderFulfilmentStatus.DELIVERY_FAILED]: 'Lỗi giao hàng',
  [OrderFulfilmentStatus.PICKUP_FAILED]: 'Lấy hàng thất bại',
}
