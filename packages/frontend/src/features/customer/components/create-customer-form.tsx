...
import { useCreateCustomer } from '@/lib/api/queries/customer/create-customer'
...
const CreateCustomerForm = ({ onCompleted, onError }: CreateCustomerFormProps) => {
