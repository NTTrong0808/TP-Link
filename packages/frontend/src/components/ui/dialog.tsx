    ...
    <DialogPortal container={container}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'border border-neutral-grey-100 bg-neutral-white p-4 shadow-lg duration-200 data-[state=open]:animate-in',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('text-base leading-4 font-medium text-neutral-black tracking-tight', className)}
    {...props}
  />
))
